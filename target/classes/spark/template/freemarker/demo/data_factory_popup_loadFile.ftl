<script>
    function showLoadFileDialog(errMsg) {
        ...
        dialog.on("shown.bs.modal", function() {
            ...
            }).filestyle({text:"Browse", btnClass:"btn-primary", placeholder:"Browse sidecar file 2 file template (*.vmpr)", badge: true});
            sc2FileInput.filestyle('disabled', true);
            ...
            sc2Switch.on("change", function () {
                if ($(this).is(':checked')) {
                    ...
                    sc2UrlInput.hide();
                    sc2Urls = [];
                    sc2FileInput.show().filestyle({text:"Browse", btnClass:"btn-primary", placeholder:"Browse sidecar file 2 file template (*.vmpr)", badge: true,});
...
<div id="loadFile_popup" hidden>
    ...
    <div class="col-sm-12">
        ...
        <div class="form-group col-sm-12">
            ...
            <input type="file" name="sc2_file" class="form-control" accept=".sc2.json,.json,.sc2,.vmpr" multiple>
